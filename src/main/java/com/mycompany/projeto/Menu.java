...
public class Menu {
	...
	public static void main(String[] args) {
		...
		} while (("1) Creditos".equals(choice) && ("2) Viajem a Praia".equals(choice)) && ("3) Desconto".equals(choice)) && ("4) Imc".equals(choice)) && ("5) Conta de Luz".equals(choice))
			&& ("6) Conta de Agua".equals(choice)) && ("1".equals(choice))
			&& "2".equals(choice)) && ("3".equals(choice)) && ("4".equals(choice)) && ("5".equals(choice)) && ("6".equals(choice)));
		if (("7) Sair".equals(choice) && ("7".equals(choice)))) {
